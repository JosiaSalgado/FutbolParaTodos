                    ...
                    ?>
                                    ...
                                    <div class="col-12 mt-3 reservaBox border border-warning d-flex">
                                        ...
                                        <div class="botones col-2 align-items-center d-flex ">
                                            <a href="../../php/trabajadores/aceptarReserva.php?id=<?php echo $row['id']?>" class="btn btn-success me-3 aceptar"><i class="bi bi-check-lg"></i></a>
                                            <a href="../../php/trabajadores/eliminarReserva.php?id=<?php echo $row['id']?>" class="btn btn-danger rechazar"><i class="bi bi-x-lg"></i></a>
                                        </div>
                                    </div>
