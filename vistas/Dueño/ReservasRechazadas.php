            ...
            <div class="row">
                ...
                <div class="col-12">
                    <ul class="nav nav-tabs mt-3 fs-5">
                        ...
                        <li class="nav-item pe-3">
                            <a class="nav-link fw-bold active" href="ReservasRechazadas.php">Reservas Rechazadas</a>
                        </li>
                ...
                <div class="container container-reservas">
                    ...
                    if ($inc) {
                        $consulta = "SELECT * FROM reservascreadas where estado = '2'";
                    ...
                    ?>
                                ...
                                <div class="col-12 mt-3 reservaBox border border-danger d-flex">
